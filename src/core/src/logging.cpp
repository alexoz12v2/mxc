...
auto printLog(LogLevel level, char const *file, int32_t const line, char const *outMessage) -> void
{
    ...
    {
    case LogLevel::info:
        fmt::print("\033[37m{} {} [{}]: ", file, line, "INFO");
        break; // white info
    case LogLevel::debug:
        fmt::print("\033[32m{} {} [{}]: ", file, line, "DEBUG");
        break; // green debug
    case LogLevel::warn:
        fmt::print("\033[33m{} {} [{}]: ", file, line, "WARN");
        break; // yellow warn
    case LogLevel::error:
        fmt::print("\033[31m{} {} [{}]: ", file, line, "ERROR");
        break; // red error
    case LogLevel::trace:
        fmt::print("\033[37m{} {} [{}]: ", file, line, "TRACE");
        break; // white trace
    }
