#ifndef MXC_PLATFORM_X86_64_SSE2_H
#define MXC_PLATFORM_X86_64_SSE2_H
...
// even though we are using runtime dispatch, we need to compile time check of availability of intrinsics because
// gcc/clang remove them if the appropriate compiler option is turned off
// TODO: this is ugly and I'm not sure it works. Find a new solution
...
#endif // MXC_PLATFORM_X86_64_SSE2_H
