...
#define MXC_SIMD_PERMUTE_CTRL(p1, p2, p3, p4) []() -> int		\
{																\
	MXC_ASSERT(													\
		(p1) >= 0u && (p1) < 4u &&								\
		(p2) >= 0u && (p2) < 4u &&								\
...
// expects a POT
#define MXC_ASSUME_ALIGNED(p, align) __assume(((((char*) p) - ((char*)0)) << (mxc::platform::x86_64::detail::highbitindex<align>::value)) == 0),	\
