...
// WARNING: DO NOT USE. THIS USES THE HOST (Compiling machine) ARCHITECTURE ONLY, and is dependent on -march | /arch
// flag to generate appropriate code checks for architecture should be done at runtime
namespace mxc::simd
{
