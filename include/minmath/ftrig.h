...
namespace mmath
{
    ...
    MMATH_FORCE_INLINE auto constexpr tan(float const x) -> float
    {
        ...
        float in = (x+detail::pihalved-pi*static_cast<int64_t>((x+detail::pihalved)*detail::oneoverpi))-detail::pihalved;
        ...
        float const res = in_sign*( -1.f/(in-detail::pihalved)-detail::twooverpi
