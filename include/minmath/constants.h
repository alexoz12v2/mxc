...
namespace mmath 
{
    ...
    inline float constexpr m0 = std::bit_cast<float>(0x8000'0000);
    inline float constexpr p0 = std::bit_cast<float>(0x0000'0000);
    inline uint32_t constexpr m0_repr = 0x8000'0000;
    inline uint32_t constexpr p0_repr = 0x0000'0000;
}
